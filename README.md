...
<table>
  <tr>
    <td width="50%" valign="top"><img src=".github/assets/home.jpg" alt="홈" width="100%"><br><sub>홈 · 한정반 배너 · 개인화 추천</sub></td>
    <td width="50%" valign="top"><img src=".github/assets/product-list.jpg" alt="상품 목록" width="100%"><br><sub>상품 목록 · 앨범당 대표 프레싱으로 축약</sub></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><img src=".github/assets/product-detail.jpg" alt="상품 상세" width="100%"><br><sub>상품 상세 · 프레싱 스펙과 다른 에디션</sub></td>
    <td width="50%" valign="top"><img src=".github/assets/limited-drop.jpg" alt="한정반" width="100%"><br><sub>한정반 드롭</sub></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><img src=".github/assets/cart.jpg" alt="장바구니" width="100%"><br><sub>장바구니</sub></td>
    <td width="50%" valign="top"><img src=".github/assets/admin-products.jpg" alt="관리자 상품 관리" width="100%"><br><sub>관리자 · 상품 관리</sub></td>
  </tr>
</table>
