...
/**
 * 테스트용 쿠폰 픽스처 (#92~). 정책·회원쿠폰 빌더 단축 + 만료 배치 검증을 위한 {@code expiresAt}
 * 강제 설정 헬퍼.
 */
public final class CouponFixtures {
    ...
    /** 정액 1,000원 · 최소주문 0 · 한정 {@code totalQuantity} (null 이면 무제한). */
    ...
    /** ISSUED 회원쿠폰 — {@code expiresAt} 을 강제 설정해 만료 배치 검증에 사용. */
