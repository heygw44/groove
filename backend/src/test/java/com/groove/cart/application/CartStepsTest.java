...
class CartStepsTest {
    ...
    @BeforeEach
    void setUp() {
        cartSteps = new CartSteps(cartRepository, albumRepository, memberRepository);
    ...
    void addItem_lazyCreatesCart() {
        ...
        Cart cart = cartSteps.addItem(1L, 10L, 2);
    ...
    void addItem_accumulates() {
        ...
        Cart cart = cartSteps.addItem(1L, 10L, 3);
    ...
    void addItem_hiddenAlbumRejected() {
        ...
        assertThatThrownBy(() -> cartSteps.addItem(1L, 10L, 2))
    ...
    void addItem_albumNotFound() {
        ...
        assertThatThrownBy(() -> cartSteps.addItem(1L, 99L, 2))
    ...
    void removeItem_notInOwnCart() {
        ...
        assertThatThrownBy(() -> cartSteps.removeItem(1L, 12345L))
    ...
    void write_memberWithdrawn_throws() {
        ...
        assertThatThrownBy(() -> cartSteps.clear(withdrawnMemberId))
