...
public class AlertConfig {
	...
	public AlertNotifier alertNotifier(AlertProperties properties, RestClient alertRestClient, Executor alertExecutor,
		...
		if (properties.slackWebhookUrl() == null || properties.slackWebhookUrl().isBlank()) {
		...
		return new SlackWebhookAlertNotifier(alertRestClient, properties.slackWebhookUrl(), alertExecutor, throttle,
				clock, serviceLabel);
	}
