...
public class AuthController {
    ...
    /**
     * Refresh Token 회전. 쿠키의 refresh 를 회전해 새 access 는 body 로, 새 refresh 는 HttpOnly 쿠키로 내린다.
     * 쿠키 미존재·재사용·만료·형식 오류는 401.
     */
    ...
    /**
     * 로그아웃. 쿠키가 있으면 revoke, 없거나 무효면 무동작. 어느 경우든 Max-Age=0 쿠키로 삭제하고 항상 200(멱등).
     */
