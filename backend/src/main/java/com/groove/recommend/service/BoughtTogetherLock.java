...
/** 공동구매 집계 스케줄러의 동시 실행을 막는 MySQL named lock 래퍼. */
@Slf4j
@Component
public class BoughtTogetherLock {

	static final String LOCK_NAME = "groove:bought-together";

	private final NamedLock namedLock;

	@Autowired
	public BoughtTogetherLock(DataSource dataSource, AlertNotifier alertNotifier) {
