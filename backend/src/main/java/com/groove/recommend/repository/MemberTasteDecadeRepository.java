...
public interface MemberTasteDecadeRepository extends JpaRepository<MemberTasteDecade, MemberTasteDecadeId> {

	List<MemberTasteDecade> findAllByProfileId(Long profileId);

	@Modifying(clearAutomatically = true, flushAutomatically = true)
	@Query("delete from MemberTasteDecade d where d.profile.id = :profileId")
	 ...
	 */
	default void replaceAll(Long profileId, List<MemberTasteDecade> items) {
