...
/** 한정반 오픈/마감 스케줄러의 동시 실행을 막는 MySQL named lock 래퍼. */
@Slf4j
@Component
public class LimitedDropScheduleLock {

	static final String LOCK_NAME = "groove:limited-drop-schedule";

	private final NamedLock namedLock;

	@Autowired
	public LimitedDropScheduleLock(DataSource dataSource, AlertNotifier alertNotifier) {
