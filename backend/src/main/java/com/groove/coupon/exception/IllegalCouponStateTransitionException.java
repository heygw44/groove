...
/**
 * 쿠폰/회원쿠폰 상태 전이 위반 — canTransitionTo 가 false 인 전이가 모델 가드 메서드에서 시도된 경우.
 * - CouponStatus 측: COUPON_INVALID_STATE_TRANSITION → 409
 * - MemberCouponStatus 측: DOMAIN_RULE_VIOLATION → 422
 */
