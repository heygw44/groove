...
/** 대사 스케줄러의 동시 실행을 막는 MySQL named lock 래퍼. */
@Slf4j
@Component
public class PaymentReconcileLock {

	static final String LOCK_NAME = "groove:payment-reconcile";

	private final NamedLock namedLock;

	@Autowired
	public PaymentReconcileLock(DataSource dataSource, AlertNotifier alertNotifier) {
